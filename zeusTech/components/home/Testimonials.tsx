                ...
                <ul className="space-y-8">
                    <li className="text-sm leading-6">
                        <div className="relative group">
                            <div
                                className="absolute transition rounded-lg opacity-25 -inset-1 bg-gradient-to-r from-purple-600 to-pink-800 blur duration-400 group-hover:opacity-100 group-hover:duration-200">
                        </div>
                                <div
                        ...
                        <div className="relative group">
                            <div
                                ...
                                <div
                                    ...
                                    <p className="leading-normal text-gray-300 text-md">Now my sales are boosted thanks to Z-tech for providing me with a reliable website that gave my business a place on the internet</p>
                                </div>
                        </div>
                    </li>
                </ul>
                        ...
                        <div className="relative group">
                            <div
                                ...
                                <div
                                    ...
                                    <p className="leading-normal text-gray-300 text-md">Thanks to Z-Tech, my programming skills are now boosted as I enrolled in their bootcamp and equipped myself with an in depth knowledge in javascript, typescript and react </p>
                                </div>
