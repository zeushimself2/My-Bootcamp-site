  ...
  return (
    ...
    <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
      <div className="text-center">
        ...
        "Join Our Upcoming Web Development Bootcamp!"
 Learn to Code, Build Websites, and Launch Your Career
 Hands-On Training | Beginner Friendly | Practical | Online
      ...
      >
        ...
        <ul className="mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end">
          ...
          {/* Removed X (Twitter) icon as requested */}
  
          <li>
            <a
              href="mailto:fordjourbright41@gmail.com"
              className="text-gray-700 transition hover:opacity-75"
            >
